...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimgEnd.setImageResource(R.drawable.previewimgthree);
        ...
        numLeft = random.nextInt(15);  // число слева
        numRight = random.nextInt(15);  // число справа
        ...
        text_left.setText(array.texts3[X]);
        img_right.setImageResource(array.images3[numRight]);
        text_right.setText(array.texts3[Y]);
